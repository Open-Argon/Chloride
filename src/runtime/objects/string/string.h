...
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, starts_with)
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, ends_with)
...
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, repeat)
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, strip)
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, index_of)
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, last_index_of)
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, from_byte)
EXPOSE_ARGON_METHOD(ARGON_STRING_TYPE, to_byte)
